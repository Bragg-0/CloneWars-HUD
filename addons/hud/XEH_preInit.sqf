...
private _listDefaultBARCHelmet = str ["JLTS_CloneHelmetAB", "JLTS_CloneHelmetBARC", "ls_gar_barc_helmet", "ls_gar_airborne_helmet"];
private _listDefaultP1Helmet = str ["ls_gar_phase1_helmet", "ls_gar_phase1Pilot_helmet", "ls_sob_phase1SpecOp_helmet", "ls_gar_rex_helmet"];

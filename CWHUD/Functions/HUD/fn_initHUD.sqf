...
if (isServer) then {
	if (isNil "CWHUD_HelmetList") then {
		...
		private _listOfCompatibleHelmetFromOtherAddons = [
			...
			["ls_sob_phase1SpecOp_helmet", "P1"],
			["ls_gar_phase2_helmet", "P2"],
			["ls_gar_phase2Pilot_helmet", "P2"],
			["ls_sob_phase2SpecOp_helmet", "P2"],
			["ls_gar_rex_helmet", "P1"],
			["ls_gar_scout_helmet", "ARF"],
			["ls_gar_engineer_helmet", "ARF"],
			["ls_gar_phase1Arf_helmet", "ARF"],
			["ls_gar_phase2Arf_helmet", "ARF"],
			["ls_gar_airborne_helmet", "BARC"],
			["ls_cloneHelmet_phase2", "P2"],
			["ls_cloneHelmet_phase2Pilot", "P2"],
			["ls_cloneHelmet_arf", "ARF"]
		];
